...
<div class="study-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Create Study'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\common\models\Speciality::find()->asArray()->all(), 'id', 'title'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Speciality', 'id' => 'grid--speciality_id']
            ],
        'import_id',
        'entry_year',
        'exclusion_year',
